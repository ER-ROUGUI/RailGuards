...
model_regression = joblib.load('/home/ubuntu/railGuard/machine_learning/data_preprocessing/logistic_regression_model.pkl') ## please change the absolut path if different
...
# Example new data >>> repect the same body
new_sample = {
